...
[X1,Y1] = meshgrid(linspace(0,2,20),linspace(0,3,20));
[X2,Y2] = meshgrid(linspace(0,2,20),linspace(0,6,20));
[X3,Y3] = meshgrid(linspace(0,3,20),linspace(0,6,20));
Z11 = zeros(length(X1),length(Y1));
Z21 = zeros(length(X2),length(Y2));
Z31 = zeros(length(X3),length(Y3));
Z12 = 6 * ones(length(X1),length(Y1));
Z22 = 3 * ones(length(X2),length(Y2));
Z32 = 2 * ones(length(X3),length(Y3));
h(1) = surf(Z21,Y2,X2);
hold on;
h(2) = surf(Y1,Z11,X1);
h(3) = surf(X3,Y3,Z31);
...
probe(1) = surf(x1,y1,z1, "Facecolor", [0.75,0.75,0.75]);
